...
contract FlightSuretyApp {
    ...
    uint8 private constant MIN_COUNT_BEFORE_MULTI_CONCESUS = 4;
    ...
    mapping(bytes32 => Flight) private flightMapping;
    ...
    */
    ...
    {
         // Modified to call data contract's status
    ...
    */
    ...
    {
        require(dataContract.airlineExists(airlineAddress), "Airline does not exist");
        _;
    }

    modifier requireIsAirlineFunded(address airlineAddress)
    {
        require(dataContract.isAirlineFunded(airlineAddress), "Airline is not funded");
        _;
    }
    ...
    */
    ...
    {
        // Only existing airline may register a new airline until there are at least four airlines registed.
        if (dataContract.getRegisteredAirlinesCount() < MIN_COUNT_BEFORE_MULTI_CONCESUS) {
    ...
    {
        require(!dataContract.airlineRegistered(airlineAddress), "Airline is not registered");
    ...
    */
                        ...
                        requireIsAirlineFunded(msg.sender)
    {
        ...
        require(!flightMapping[flightKey].isRegistered, "Flight is already registered. Unable to process.");

        flightMapping[flightKey] = Flight(
            {
    ...
    */
                            ...
                            internal 
    {
        ...
        flightMapping[flightKey].statusCode = statusCode;
    ...
    function fundAirline
                    ...
                    requireIsOperational
    {
        require(msg.sender == airlineAddress, "Airline address is not equal to the sender.");
        require(msg.value >= AIRLINE_FUND, "Airline fund is not sufficient.");
...
// region ORACLE MANAGEMENT
    ...
    // Event fired when insurance is bought
